...
const load = async () => {
    ...
    const prev_cities = await fetch('https://raw.githubusercontent.com/aZolo77/citiesBase/master/cities.json');
...
const set_name = (type) => {
    ...
    if (type === 'first_name'){
        ...
        // Иначе
            ...
            document.getElementById('first_name_button').style.backgroundColor = 'green';
            document.getElementById('first_name_button').style.color = 'white';
    ...
    // Если проверяем поле второго игрока
        ...
        // Иначе
            ...
            // Изменяем цвет кнопки на зеленый и текст - на белый, как он просил.
            document.getElementById('second_name_button').style.backgroundColor = 'green';
            document.getElementById('second_name_button').style.color = 'white';
            // Отключает ввод текста в поле и кнопку, а также прячем поле с ошибкой, если оно было видно.
...
const initialize_second_window = () => {
    ...
    document.getElementById('second_div').style.display = 'initial';
    ...
    document.getElementById('step_announce').innerText = 'Ваш ход, ' + (is_first ? first_name : second_name);
...
const check_city = () => {
    ...
    if (!check_value){
        ...
        error_field.innerText = `Игрок ${is_first ? first_name : second_name} обязан ввести имя города!`
        ...
        */
        ...
        // Иначе
            ...
            if (is_first){
                ...
                document.getElementById('step_announce').innerText = 'Ваш ход, ' + second_name;
                document.getElementById('first_name_count').innerText = String(Number(document.getElementById('first_name_count').innerText) + 1)
            }
            // Иначе
            else{
                ...
                document.getElementById('step_announce').innerText = 'Ваш ход, ' + first_name;
                document.getElementById('second_name_count').innerText = String(Number(document.getElementById('second_name_count').innerText) + 1)
            }
...
const give_up = (user) => {
    ...
    if (user == 'first'){
        ...
        document.getElementById('congrats').innerText = `Поздравляем Вас, ${second_name}! Вы - победитель!`
        document.getElementById('score').innerText = `Ваш результат (количество отгаданных городов): ${document.getElementById('second_name_count').innerText}!`
    }
    // Иначе
    else{
        ...
        document.getElementById('congrats').innerText = `Поздравляем Вас, ${first_name}! Вы - победитель!`
        document.getElementById('score').innerText = `Ваш результат (количество отгаданных городов): ${document.getElementById('first_name_count').innerText}!`
    }
...
const start_new = () => {
    ...
    document.getElementById('first_name_button').style.backgroundColor = 'white';
    document.getElementById('first_name_button').style.color = 'black';
    document.getElementById('second_name_button').disabled = false
    document.getElementById('second_name_button').style.backgroundColor = 'white';
    document.getElementById('second_name_button').style.color = 'black';
